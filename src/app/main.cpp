    ...
    if (ole.ok()) {
      ...
      if (window.create(instance, showCommand)) {
        ...
        ACCEL accels[] = {
            ...
            {static_cast<BYTE>(FCONTROL | FVIRTKEY), L'B',
             fast_explorer::ui::kAccelToggleNavigationTree},
            ...
            {static_cast<BYTE>(FCONTROL | FVIRTKEY), L'T',
             fast_explorer::ui::kAccelNewTab},
            {static_cast<BYTE>(FCONTROL | FVIRTKEY), L'W',
             fast_explorer::ui::kAccelCloseTab},
            {static_cast<BYTE>(FCONTROL | FVIRTKEY), VK_TAB,
